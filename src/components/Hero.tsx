          ...
          <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
            <div className="text-center xl:col-span-1 lg:text-left md:px-16 lg:px-0 xl:pr-20">
              <h1
                ...
                data-aos-delay="100"
                data-aos-once="true"
                className="text-4xl font-bold leading-tight text-[#99EFD0] sm:text-5xl sm:leading-tight lg:text-5xl lg:leading-tight hero-heading"
              >
              ...
              <p
                ...
                data-aos-delay="200"
                data-aos-once="true"
                className="mt-2 text-lg text-[#8476AA] sm:mt-6 font-semibold hero-subtext "
              >
                ...
                <div className="relative flex flex-col h-full  rounded-sm lg:items-center lg:flex-row">
                  <div className=" lg:mr-6 lg:mb-0">
                    <div
                      ...
                      data-aos-delay="500"
                      data-aos-once="true"
                      className="flex items-center justify-center my-8 lg:w-32 lg:h-32"
                    >
                      <img src={Play} alt="" />
                    </div>
                  </div>
                  <div className="flex flex-col items-center lg:items-start justify-between flex-grow playfont">
                    <div>
                      <h6
                        ...
                        data-aos-delay="600"
                        data-aos-once="true"
                        className="mb-2 font-semibold leading-5 text-[#8476AA]"
                      >
